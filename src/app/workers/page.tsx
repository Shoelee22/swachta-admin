  ...
  return (
    <main style={{ padding: 32, maxWidth: 880 }}>
      ...
      <div style={{ marginTop: 24, display: 'grid', gap: 12 }}>
        {rows.map((row) => (
          <div key={row.id} style={{ background: '#fff', border: '1px solid #E5E7EB', borderRadius: 16, padding: 16, display: 'flex', justifyContent: 'space-between', alignItems: 'center', flexWrap: 'wrap', gap: 8 }}>
            <div>
